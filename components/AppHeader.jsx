...
export default function AppHeader() {
  ...
  return (
    <View style={{padding:10,paddingBottom:10, backgroundColor:'#BED7DC',gap:5}}>
            <View>
                <Text style={{fontSize:width>1200?fontScale*50:fontScale*20,color:'#2C4E80',fontWeight:'bold',marginRight:210}}>Book Store</Text>
            </View>
            ...
            <View style={{flexDirection:'row',gap:10,justifyContent:'space-around'}}>
                ...
                <Pressable style={{borderWidth:2,padding:5,borderRadius:10,backgroundColor:'white',borderColor:'#B3C8CF'}}>
                    <Image source={require('../assets/images/search.png')} style={{width:width>1200?width*0.005:width*0.05,height:height>900?height*0.025:height*0.025}}></Image>
                </Pressable>
            </View>
