  ...
  return (
    <View style={{flexDirection:'column',padding:10,paddingBottom:10, backgroundColor:'#BED7DC',justifyContent:'space-around',gap:5,alignItems:'center'}}>
            ...
            <View style={{flexDirection:'row',gap:10}}>
                <TextInput placeholder='Search for a book !' style={{borderRadius:50, backgroundColor:'white', borderWidth:2, width:width>1200?width:width*0.8,textAlign:'center',borderColor:'#B3C8CF'}}></TextInput>
