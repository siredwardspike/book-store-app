    ...
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      <View style={{ alignSelf: 'center' ,flex:1,justifyContent:'center'}}>
        <View style={{ alignItems: 'center' }}>
          ...
          <View style={{ borderRadius: 30, padding:10, alignItems: 'center', marginBottom: 10, borderWidth: 2, borderBottomColor: '#EEF7FF', borderTopColor: '#EEF7FF', borderLeftColor: '#EEF7FF', borderRightColor: '#EEF7FF', borderCurve: 4 }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start' }}>
              ...
              <Text style={{ fontSize: imageWidth * imageHeight * 0.0015, fontWeight: 'normal', color: 'black' }}>: The Rock</Text>
            </View>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start' }}>
              ...
              <Text style={{fontSize: imageWidth * imageHeight * 0.0015, fontWeight: 'normal', color: 'black' }}>:dwaynejohnson@rock.com</Text>
            </View>
          ...
          <View style={{ flexDirection: 'column', alignItems: 'flex-start', alignSelf: 'center' }}>
            ...
            <Pressable style={{ flexDirection: 'row-reverse', alignItems: 'center' }}>
              <Text style={{ fontSize: imageWidth * imageHeight * 0.001, fontWeight: '600', color: '#4D869C' }}>Cart history</Text>
              <Icon name="shopping-cart" type="material" color="#4D869C" style={{ margin: 3 }} />
            </Pressable>

            <Pressable style={{ flexDirection: 'row-reverse', alignItems: 'center' }}>
              <Text style={{ fontSize: imageWidth * imageHeight * 0.001, fontWeight: '400', color: '#4D869C' }}>Whishlist</Text>
              <Icon name="list" type="material" color="#4D869C" style={{ margin: 3 }} />
            </Pressable>

            <Pressable style={{ flexDirection: 'row-reverse', alignItems: 'center' }}>
              <Text style={{ fontSize: imageWidth * imageHeight * 0.001, fontWeight: '400', color: '#4D869C' }}>Change password</Text>
              <Icon name="pin" type="material" color="#4D869C" style={{ margin: 3 }} />
            </Pressable>

            <Pressable style={{ flexDirection: 'row-reverse', alignItems: 'center' }}>
              <Text style={{ fontSize: imageWidth * imageHeight * 0.001, fontWeight: '400', color: '#4D869C' }}>Signout</Text>
